...
(function ($, window) {
    ...
    $.fn.navigationResize = function () {
        ...
        var $navItemMore = $menuContainer.find(
            "li.techmarket-flex-more-menu-item"
        );
        ...
        var $navItems = $navItemMore
                .parent()
                .children("li:not(.techmarket-flex-more-menu-item)"),
...
(function ($) {
	...
	/*===================================================================================*/
    $(".wc-tabs-wrapper ul.tm-tabs > li").on(
        "click",
        'a[href^="#"]',
        function (e) {
            // target element id
    ...
    $("body").on("woocommerce_variation_has_changed", function (e) {
        var $singleVariationWrap = $("form.variations_form").find(
            ".single_variation_wrap"
        );
        var $availability = $singleVariationWrap
            .find(".woocommerce-variation-availability")
            .html();
    ...
    $(".section-categories-filter").each(function () {
        ...
        $this.find(".categories-dropdown").change(function () {
            ...
            var $shortcode_atts = $this
                .find(".categories-filter-products")
                .data("shortcode_atts");
            if (
                $selectedKey !== "" ||
                $selectedKey !== 0 ||
    ...
    $(document).ready(function () {
        ...
        $('[data-ride="tm-slick-carousel"]').each(function () {
            ...
            if (
                $(this).data("slick") !== "undefined" &&
                $(this).find($(this).data("wrap")).length > 0
            ) {
                $slick_target = $(this).find($(this).data("wrap"));
                $slick_target.data("slick", $(this).data("slick"));
            } else if (
                $(this).data("slick") !== "undefined" &&
                $(this).is($(this).data("wrap"))
            ) {
                $slick_target = $(this);
            }
        ...
        $('a[data-toggle="tab"]').on("shown.bs.tab", function (e) {
            ...
            $($target)
                .find('[data-ride="tm-slick-carousel"]')
                .each(function () {
        ...
        $("#section-landscape-product-card-with-gallery .products").on(
            "init",
            function (event, slick) {
                $(slick.$slides[0])
                    .find(".big-image figure:eq(0)")
                    .nextAll()
                    .hide();
                $(slick.$slides[0])
                    .find(".small-images figure")
                    .click(function (e) {
                        var index = $(this).index();
                        $(slick.$slides[0])
                            .find(".big-image figure")
                            .eq(index)
                            .show()
                            .siblings()
                            .hide();
        ...
        var departments_menu_height_home_v5 = $(
                ".page-template-template-homepage-v5 .departments-menu > ul.dropdown-menu"
            ).height(),
            departments_menu_height_home_v6 = $(
                ".page-template-template-homepage-v6 .departments-menu > ul.dropdown-menu"
            ).height();

        $(".page-template-template-homepage-v5 #secondary").css(
            "margin-top",
            departments_menu_height_home_v5 + 35
        );
        $(".page-template-template-homepage-v6 #secondary").css(
            "margin-top",
            departments_menu_height_home_v6 + 35
        );

        if ($(window).width() > 768) {
            // Departments Menu Height
            var $departments_menu_dropdown = $(".departments-menu-dropdown"),
                departments_menu_dropdown_height =
                    $departments_menu_dropdown.height();
            ...
            $departments_menu_dropdown
                ...
                .each(function () {
                    $(this)
                        ...
                        .css(
                            "min-height",
                            departments_menu_dropdown_height - 4
                        );
                    $(this).css(
                        "min-height",
                        departments_menu_dropdown_height - 4
        ...
        $(document).on("click", function (event) {
            if ($(".handheld-navigation").hasClass("toggled")) {
                if (
                    !$(".handheld-navigation").is(event.target) &&
                    0 === $(".handheld-navigation").has(event.target).length
                ) {
        ...
        $(".handheld-header .site-search .search-field")
            .focus(function () {
        ...
        $(document).on("click", function (event) {
            if ($(".site-content").hasClass("active-hh-sidebar")) {
                if (
                    !$(".handheld-sidebar-toggle").is(event.target) &&
                    0 ===
                        $(".handheld-sidebar-toggle").has(event.target)
                            .length &&
                    !$("#secondary").is(event.target) &&
                    0 === $("#secondary").has(event.target).length
                ) {
    ...
    $(document).ready(function () {
        ...
        $(".home-slider").on(
            ...
            function (event, slick, currentSlide) {
                ...
                $(".slick-active .caption .bottom-caption").removeClass(
                    "hidden"
                );
                $(".slick-active .caption .bottom-caption").addClass(
                    "animated slideInDown"
        ...
        $(".home-slider").on(
            "beforeChange",
            function (event, slick, currentSlide) {
                $(".slick-active .caption .pre-title").removeClass(
                    "animated slideInRight"
                );
                $(".slick-active .caption .pre-title").addClass("hidden");

                $(".slick-active .caption .title").removeClass(
                    "animated slideInRight"
                );
                $(".slick-active .caption .title").addClass("hidden");

                $(".slick-active .caption .sub-title").removeClass(
                    "animated slideInRight"
                );
                $(".slick-active .caption .sub-title").addClass("hidden");

                $(".slick-active .caption .button").removeClass(
                    "animated slideInDown"
                );
                $(".slick-active .caption .button").addClass("hidden");

                $(".slick-active .caption .offer-price").removeClass(
                    "animated fadeInLeft"
                );
                $(".slick-active .caption .offer-price").addClass("hidden");

                $(".slick-active .caption .sale-price").removeClass(
                    "animated fadeInRight"
                );
