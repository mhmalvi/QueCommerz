<div class="home-v2-slider home-slider">
    <div class="slider-1" style="background-image: url({{asset('assets/images/slider/home-v2-background.jpg')}});">
        <img src="{{asset('assets/images/slider/home-v2-img-1.png')}}" alt="">
        <div class="caption">
