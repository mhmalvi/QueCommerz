                            ...
                            <div id="techmarket-single-product-gallery" class="techmarket-single-product-gallery techmarket-single-product-gallery--with-images techmarket-single-product-gallery--columns-4 images" data-columns="4">
                                <div class="techmarket-single-product-gallery-images" data-ride="tm-slick-carousel" data-wrap=".woocommerce-product-gallery__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;asNavFor&quot;:&quot;#techmarket-single-product-gallery .techmarket-single-product-gallery-thumbnails__wrapper&quot;}">
                                    <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4">
                                        ...
                                        <figure class="woocommerce-product-gallery__wrapper ">
                                            <div data-thumb="{{asset('assets/images/products/sm-card-1.jpg')}}" class="woocommerce-product-gallery__image">
                                                <a href="{{asset('assets/images/products/big-card.jpg')}}" tabindex="0">
                                                    <img width="600" height="600" src="{{asset('assets/images/products/big-card.jpg')}}" class="attachment-shop_single size-shop_single wp-post-image" alt="">
                                                </a>
                                            </div>
                                            <div data-thumb="{{asset('assets/images/products/sm-card-3.jpg')}}" class="woocommerce-product-gallery__image">
                                                <a href="{{asset('assets/images/products/big-card-2.jpg')}}" tabindex="-1">
                                                    <img width="600" height="600" src="{{asset('assets/images/products/big-card-2.jpg')}}" class="attachment-shop_single size-shop_single" alt="">
                                                </a>
                                            </div>
                                            <div data-thumb="{{asset('assets/images/products/sm-card-2.jpg')}}" class="woocommerce-product-gallery__image">
                                                <a href="{{asset('assets/images/products/big-card-1.jpg')}}" tabindex="-1">
                                            ...
                                            <div data-thumb="{{asset('assets/images/products/deals-sm-5.jpg')}}" class="woocommerce-product-gallery__image">
                                                <a href="{{asset('assets/images/products/big-4.jpg')}}" tabindex="-1">
                                                    <img width="600" height="600" src="{{asset('assets/images/products/big-4.jpg')}}" class="attachment-shop_single size-shop_single" alt=""> </a>
                                            </div>
                                            <div data-thumb="{{asset('assets/images/products/sm-card-2.jpg')}}" class="woocommerce-product-gallery__image">
                                                <a href="{{asset('assets/images/products/big-card-2.jpg')}}" tabindex="-1">
                                                    <img width="600" height="600" src="{{asset('assets/images/products/big-card-1.jpg')}}" class="attachment-shop_single size-shop_single" alt="">
                                ...
                                <div class="techmarket-single-product-gallery-thumbnails" data-ride="tm-slick-carousel" data-wrap=".techmarket-single-product-gallery-thumbnails__wrapper" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:1,&quot;dots&quot;:false,&quot;arrows&quot;:true,&quot;vertical&quot;:true,&quot;verticalSwiping&quot;:true,&quot;focusOnSelect&quot;:true,&quot;touchMove&quot;:true,&quot;prevArrow&quot;:&quot;&lt;a href=\&quot;#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-up\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;nextArrow&quot;:&quot;&lt;a href=\&quot;#\&quot;&gt;&lt;i class=\&quot;tm tm-arrow-down\&quot;&gt;&lt;\/i&gt;&lt;\/a&gt;&quot;,&quot;asNavFor&quot;:&quot;#techmarket-single-product-gallery .woocommerce-product-gallery__wrapper&quot;,&quot;responsive&quot;:[{&quot;breakpoint&quot;:765,&quot;settings&quot;:{&quot;vertical&quot;:false,&quot;horizontal&quot;:true,&quot;verticalSwiping&quot;:false,&quot;slidesToShow&quot;:4}}]}">
                                    <figure class="techmarket-single-product-gallery-thumbnails__wrapper">
                                        <figure data-thumb="{{asset('assets/images/products/sm-card-1.jpg')}}" class="techmarket-wc-product-gallery__image">
                                            <img width="180" height="180" src="{{asset('assets/images/products/sm-card-1.jpg')}}" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">
                                        </figure>
                                        <figure data-thumb="{{asset('assets/images/products/sm-card-3.jpg')}}" class="techmarket-wc-product-gallery__image">
                                            <img width="180" height="180" src="{{asset('assets/images/products/sm-card-3.jpg')}}" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                        </figure>
                                        <figure data-thumb="{{asset('assets/images/products/sm-card-2.jpg')}}" class="techmarket-wc-product-gallery__image">
                                            <img width="180" height="180" src="{{asset('assets/images/products/sm-card-2.jpg')}}" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                        </figure>
                                        <figure data-thumb="{{asset('assets/images/products/big-4.jpg')}}" class="techmarket-wc-product-gallery__image">
                                            <img width="180" height="180" src="{{asset('assets/images/products/big-4.jpg')}}" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                        </figure>
                                        <figure data-thumb="{{asset('assets/images/products/sm-card-2.jpg')}}" class="techmarket-wc-product-gallery__image">
                                            <img width="180" height="180" src="{{asset('assets/images/products/sm-card-2.jpg')}}" class="attachment-shop_thumbnail size-shop_thumbnail" alt="">
                                        </figure>
                    ...
                    <div class="techmarket-tabs techmarket-tabs-wrapper wc-tabs-wrapper">
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="single-product-fullwidth.html">
                                                        <img width="224" height="197" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="{{asset('assets/images/products/14.jpg')}}">
                                                        <span class="price">
                                                            <del>
                                                                <span class="woocommerce-Price-amount amount">
                                                ...
                                                <div class="product">
                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="single-product-fullwidth.html">
                                                        <img width="224" height="197" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="{{asset('assets/images/products/9.jpg')}}">
                                                        <span class="price">
                                                            <del>
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">$</span>1,239.99</span>
                                                ...
                                                <div class="product">
                                                    <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="single-product-fullwidth.html">
                                                        <img width="224" height="197" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="{{asset('assets/images/products/2.jpg')}}">
                                                        <span class="price">
                                                            <del>
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <span class="woocommerce-Price-currencySymbol">$</span>1,239.99</span>
                        ...
                        <div id="tab-description" class="techmarket-tab">
                            <div class="tab-content">
                                ...
                                <div class="outer-wrap">
                                    <div class="image-info">
                                        <img src="{{asset('assets/images/products/des2.png')}}" class="alignnone" alt="">
                                    </div>
                                    <!-- .image-info -->
                                    <div class="content-info">
