                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="product-thumbnail">
                                                    <a href="{{route('product')}}">
                                                        <img width="180" height="180" alt="" class="wp-post-image" src="{{route('product')}}">
                                                    </a>
                                                </td>
                                                <td data-title="Product" class="product-name">
                                                    <div class="media cart-item-product-detail">
                                                        ...
                                                        <div class="media-body align-self-center">
                                                            <a href="{{route('product')}}">55" KU6470 6 Series UHD  Crystal Colour HDR Smart TV</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td data-title="Product" class="product-name">
                                                    <div class="media cart-item-product-detail">
                                                        <a href="{{route('product')}}">
                                                            <img width="180" height="180" alt="" class="wp-post-image" src="{{asset('assets/images/products/cart-2.jpg')}}">
                                                        </a>
                                                        <div class="media-body align-self-center">
                                                            <a href="{{route('product')}}">4K Action Cam GPS</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td data-title="Price" class="product-price">
                                            ...
                                            <tr>
                                                ...
                                                <td data-title="Product" class="product-name">
                                                    <div class="media cart-item-product-detail">
                                                        <a href="{{route('product')}}">
                                                            <img width="180" height="180" alt="" class="wp-post-image" src="{{asset('assets/images/products/cart-3.jpg')}}">
                                                        </a>
                                                        <div class="media-body align-self-center">
                                                            <a href="{{route('product')}}">Bluetooth on-ear PureBass Headphones</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td data-title="Price" class="product-price">
